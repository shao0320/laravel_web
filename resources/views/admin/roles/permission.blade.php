        ...
        <div class="col-sm-9 col-lg-12">
          ...
          <div class="panel panel-default">
            <div class="panel-heading">
              ...
              <h4 class="panel-title">编辑[{{$roles->rolename}}]权限</h4>
            </div>

            <form action="{{ route('admin.save.role.permission')}}" method="post" id="role-permissions-form">
            	{{csrf_field()}}
			                ...
			                <div class="sub-permissions col-md-11 col-md-offset-1">
			                  <div class="col-sm-6">
			                    ...
			                    <label><input type="checkbox" name="permissions[]"
			                                  value="{{$sub['id']}}"
			                                  class="sub-permission-checkbox" @if(in_array($permission['id'] ,$p_ids)) checked @endif/>{{$sub['name']}}&nbsp;&nbsp;&nbsp;&nbsp;
			                    </label>&nbsp;&nbsp;
			                    @endforeach
			                  </div>
			                </div>
