        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" action="/admin/article/category/doEdit" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="文章分类名称" class="form-control" name="cate_name" value="{{$list->cate_name}}" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label">文章分类描述</label>
                    <div class="col-sm-6">
                        <textarea class="form-control" rows="3" name="cate_desc">{{$list->cate_desc}}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="文章分类排序" class="form-control" name="cate_order" value="{{$list->cate_order}}" />
                    </div>
                </div>
