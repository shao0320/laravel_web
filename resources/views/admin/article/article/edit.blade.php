...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body panel-body-nopadding">
            ...
            <form class="form-horizontal form-bordered" action="/admin/article/article/doEdit" method="post">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="form-control" name="cate_id">
                            ...
                            @if(!empty($cate))
                                @foreach($cate as $v)
                                    <option value="{{$v['id']}}" @if($info->cate_id == $v['id'] ) selected @endif>{{$v['cate_name']}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
