                ...
                <table class="table table-success mb30">
                    ...
                    <tbody>
                      <tr v-for="permission in permission_list">
                        ...
                        <td>
                        	<button class="btn btn-danger btn-sm" v-on:click="getPermissionList(permission.id)">查看子级</button>
                        	<button class="btn btn-danger btn-sm" v-if="permission.fid>0" v-on:click="getPermissionList()">返回</button>
