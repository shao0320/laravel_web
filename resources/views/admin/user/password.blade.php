    ...
    <div class="" id="pwd">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body panel-body-nopadding">
                ...
                <form id="password_form" class="form-horizontal form-bordered" action="/admin/user/doPassword" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <image src="{{$image_url or null}}" style="width: 70px;"/>
                            <span class="help-block"></span>
                        </div>
                    </div>
                    <div class="form-group">
