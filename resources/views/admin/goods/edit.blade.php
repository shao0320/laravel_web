...
@section('content')
    ...
    <div id="goods_add">
        ...
        <div class="panel panel-default">
            ...
            <form class="form-horizontal form-bordered" action="/admin/goods/doEdit" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                ...
                <div class="panel-body panel-body-nopadding" v-show="tab==3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text"  value="" class="form-control" name="image_url[][image_name]">
                            <span class="help-block"></span>
                        </div>
                        <label class="col-sm-2 control-label">商品图片</label>
                        <div class="col-sm-3">
                            <input type="file" placeholder="输入用户名" value="" class="form-control" name="image_url[][image_url]">
                            <span class="help-block"></span>
                        </div>
                        <div class="col-sm-1">
