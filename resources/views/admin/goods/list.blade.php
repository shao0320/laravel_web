...
@section('pageHeader')
    <div class="pageheader">
        ...
        <div class="breadcrumb-wrapper">
            ...
            <a class="btn btn-sm btn-success" href="/admin/goods/import">商品导入</a>
        </div>
    </div>
@endsection
            ...
            <div class="table-responsive">
                <table class="table table-primary  mb30">
                    ...
                    <tr v-for="goods in goods_list">
                        ...
                        <td>
                            <a v-bind:href="'/admin/goods/sku/add/'+goods.id" class="btn btn-sm btn-success">属性</a>
