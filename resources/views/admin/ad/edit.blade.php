            ...
            <form class="form-horizontal form-bordered" action="/admin/ad/doEdit" method="post" enctype="multipart/form-data">
                        ...
                        <select class="form-control" name="position_id">
                            ...
                            @if(!empty($position))
                                @foreach($position as $v)
                                    <option value="{{$v['id']}}" @if($info->position_id == $v['id']) selected @endif >{{$v['position_name']}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <img src="{{$info->image_url}}" alt="" style="width:50px;">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <div class="radio"><label><input type="radio" name="status" value="1" @if($info->status == 1) checked @endif> 开启</label></div>
                        <div class="radio"><label><input type="radio" name="status" value="2" @if($info->status ==2 ) checked @endif>关闭</label></div>
                    </div>
                </div>
